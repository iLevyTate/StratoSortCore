      ...
      <EdgeLabelRenderer>
        ...
        >
          ...
          {isHovered && (
            ...
            >
              <div className="bg-gray-900 text-white text-xs rounded-lg shadow-xl p-3 space-y-2 animate-in fade-in zoom-in-95 duration-150">
                {/* Header */}
                <div
                  className={`font-semibold border-b border-gray-700 pb-1.5 ${headerColorClass}`}
                >
                  {title}
                </div>
